<?php
/*/" . ROOT . "
include("http://localhost/blooger/assets/classes/autoload.php");
    $user_data = [];
    if(isset($_SESSION['blooger_userid']))
    {
        $login = new Login();
        $user_data = $login->check_login($_SESSION['blooger_userid']);
...
<script>
    ...
    function get_data2(id){
        ...
        const url = 'http://localhost/blooger/api/posts/2529/html';
...
<body>
  <button onclick="get_data2()" type="button">fetch data</button>
